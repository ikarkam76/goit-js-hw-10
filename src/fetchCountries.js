    ...
    if (countries.length > 10) {
      ...
      if (countries.length === 1) {
        ...
        const htmlString = `<div class="country__box">
            ...
            <p class="country__info">Capital:  ${countries[0].capital}</p>
            <p class="country__info">Population:  ${countries[0].population}</p>
            <p class="country__info">Languages:  ${Object.values(countries[0].languages).join(',')}</p>`;
